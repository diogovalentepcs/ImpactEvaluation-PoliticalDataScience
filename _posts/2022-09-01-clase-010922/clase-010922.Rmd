---
title: "Clase 01/09/22 - Modelos lineales"
...
tema <- theme_set(theme_minimal(base_family = "Arial") +
...
```{r warning=F, echo=F, message=F, out.width="50%", out.height="50%"}
vdem_subset %>%
  ggplot(aes(x = e_peedgini, y = v2x_cspart)) +
  geom_point() +
...
```{r warning=F, echo=F, message=F, out.width="70%", out.height="60%"}
