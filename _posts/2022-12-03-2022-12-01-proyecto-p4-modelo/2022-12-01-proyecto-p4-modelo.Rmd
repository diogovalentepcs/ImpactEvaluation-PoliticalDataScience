...
1. Los viajes en bicicleta no están sustituyendo a los viajes en coche en horas de punta, sino que podrían estar sustituyendo el transporte público o los desplazamientos a pie, en momentods de ocio. Este razonamiento es desarrollado más adelante por
...
Este trabajo tiene grandes limitaciones, siendo la principal la falta de un contrafactual confiable (Santiago sin la nueva estructura de Bike Itaú, al mismo tiempo). Esto se ve mitigado por los controles empíricos agregados al modelo, pero también deberíamos estudiar un contrafactual. Gallego et al. (2013) propone utilizar una pequeña ciudad de Chile como contrafactual debido a sus tendencias similares de CO. Podríamos construir un modelo de Diferencia en Diferencias que nos permitiría controlar los efectos de los factores externos.
